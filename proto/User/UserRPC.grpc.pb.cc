...
UserService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_GetUsersByRole_(UserService_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_AddUsers_(UserService_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::CLIENT_STREAMING, channel)
  , rpcmethod_DeleteUsers_(UserService_method_names[3], options.suffix_for_stats(),::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  {}
...
void UserService::Stub::async::GetUser(::grpc::ClientContext* context, const ::TestGRPC::UserAccountName* request, ::TestGRPC::User* response, std::function<void(::grpc::Status)> f) {
...
void UserService::Stub::async::GetUser(::grpc::ClientContext* context, const ::TestGRPC::UserAccountName* request, ::TestGRPC::User* response, ::grpc::ClientUnaryReactor* reactor) {
...
void UserService::Stub::async::GetUsersByRole(::grpc::ClientContext* context, const ::TestGRPC::UserRole* request, ::grpc::ClientReadReactor< ::TestGRPC::User>* reactor) {
...
void UserService::Stub::async::AddUsers(::grpc::ClientContext* context, ::TestGRPC::CommonNumber* response, ::grpc::ClientWriteReactor< ::TestGRPC::User>* reactor) {
...
void UserService::Stub::async::DeleteUsers(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::TestGRPC::UserAccountName,::TestGRPC::CommonMsg>* reactor) {
