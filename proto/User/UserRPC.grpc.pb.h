...
#ifndef GRPC_proto_2fUser_2fUserRPC_2eproto__INCLUDED
#define GRPC_proto_2fUser_2fUserRPC_2eproto__INCLUDED
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      #else
      virtual void GetUsersByRole(::grpc::ClientContext* context, const ::TestGRPC::UserRole* request, ::grpc::experimental::ClientReadReactor< ::TestGRPC::User>* reactor) = 0;
      #endif
      // 批量增加新用户，返回服务器用户总数
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
...
#endif  // GRPC_proto_2fUser_2fUserRPC_2eproto__INCLUDED
